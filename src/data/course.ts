...
export const courseParts: CoursePart[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { day: 23, title: "Naturaleza jurídica del contrato de depósito irregular de dinero", topics: "Contrato de préstamo (comodato y mutuo) frente a contrato de depósito. Bienes fungibles y el tantundem. Depósito regular e irregular. Coeficiente de caja del 100% y delito de apropiación indebida. Origen romano del derecho: Ulpiano, Papiniano y el Digesto.", companionUrl: companionUrl(23), notebookVideos: [{ title: "Clase 23. Depósitos vs Préstamos: ¿Tu dinero está a salvo? Huerta de Soto te cuenta la Verdad.", url: "https://www.youtube.com/watch?v=2gf2jXGGcbA" }] },
